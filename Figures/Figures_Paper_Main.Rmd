...
ggplot2::ggsave("../Figures/Figs/Figure4_Enrichment_alternative.pdf",
                plt_final,
                width = 12, height=14, bg = 'white')
```
...
p7_main <- make_plot(dfB, "gene_n", "-log10(p_enrich)", expression(-log[10]*"(p-value)")) 
p8_main <- make_plot(dfB, "gene_n", "-log10(p_score)", expression(-log[10]*"(p-value)"))  
