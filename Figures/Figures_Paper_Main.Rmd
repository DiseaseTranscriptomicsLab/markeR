...
(plt_fig3_new <- ggarrange(plt_ranking_simpler, plt_cellagedirnodir+ 
  theme(plot.margin = unit(c(0, 5, 35, 15), "pt")), nrow=1, widths = c(0.7,0.3), labels = "AUTO"))
```
...
plt_senequest <- ggarrange(plt_scores,plt_tstats, ncol=1, heights=c(0.6,0.5), labels=c("","E"))
