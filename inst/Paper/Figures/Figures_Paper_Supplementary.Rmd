...
(supfig5 <-  ggarrange(plt_gtex_scores_SenMayo,plt_scoredistribution_SenMayo_GTEx, heights=c(0.4,0.6), labels = c("A","B"), nrow=2))
ggplot2::ggsave("Figs/SupFigure5_GTEx_SenMayo.png",
                supfig5,
                width = 12, height=15A, bg = 'white')
