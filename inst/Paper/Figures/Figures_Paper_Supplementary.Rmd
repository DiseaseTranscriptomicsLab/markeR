...
```{r}
ggplot2::ggsave("Figures/Figs/Sup2_GeneSets_Function_Localisation.png",
                supfig2,
...
```{r}
ggplot2::ggsave("Figures/Figs/Sup3_Scores_SenescenceStressors.png",
                supfigure_3,
...
```{r}
ggplot2::ggsave("Figures/Figs/Sup4_FPRsimulations.png",
                plt_fdrsim_allsignatures_v2,
