...
#> 1: Senescence_Bidirectional 0.02061856 0.04123711 0.14390962 0.7068136 1.656863
#> 2:               Senescence 0.14534974 0.14534974 0.04498782 0.5844505 1.338318
#>     size                         leadingEdge stat_used
#>    <int>                              <list>    <char>
#> 1:     7 LMNB1,MKI67,GLB1,CDKN1A,CDKN2A,CCL2         t
#> 2:     7             LMNB1,MKI67,GLB1,CDKN1A         B
```
...
<img src="man/figures/README-GSEA_varassoc-1.png" width="60%" />
    ...
    #> 1: Senescence 0.1491721 0.3729303 0.04441237  0.5844505  1.3353823     7
    #> 2: Senescence 0.8141012 0.8601964 0.01825547  0.2197875  0.7181662     7
    #> 3: Senescence 0.1182382 0.3729303 0.05965783  0.4198163  1.3763538     7
    #> 4: Senescence 0.8601964 0.8601964 0.01605830 -0.2113031 -0.6823033     7
    #> 5: Senescence 0.5459652 0.8601964 0.02248936 -0.2849369 -0.9167063     7
    #>                                leadingEdge stat_used                  Contrast
    #>                                     <list>    <char>                    <char>
    #> 1:                 LMNB1,MKI67,GLB1,CDKN1A         B Proliferative - Senescent
...
<img src="man/figures/README-GSEA_varassoc2-1.png" width="60%" />
    ...
    #> 1: Senescence_Bidirectional 0.020935961 0.0523399 0.14247037 -0.7068136
    #> 2: Senescence_Bidirectional 0.068614515 0.1143575 0.07428177  0.6399995
    #> 3: Senescence_Bidirectional 0.008800459 0.0440023 0.21338792  0.7274186
    #> 4: Senescence_Bidirectional 0.952752753 0.9527528 0.01514179 -0.2471009
    #> 5: Senescence_Bidirectional 0.323262840 0.4040785 0.03300122  0.4899121
    #>           NES  size                         leadingEdge stat_used
    #>         <num> <int>                              <list>    <char>
    #> 1: -1.6714212     7 LMNB1,MKI67,GLB1,CDKN1A,CDKN2A,CCL2         t
    #> 2:  1.4635050     7   GLB1,TP53,CDKN1A,CCL2,MKI67,LMNB1         t
    #> 3:  1.7702760     7 LMNB1,CDKN1A,GLB1,CDKN2A,MKI67,CCL2         t
    #> 4: -0.5749404     7                  CDKN2A,LMNB1,MKI67         t
    #> 5:  1.1279001     7 GLB1,CDKN1A,CCL2,CDKN2A,MKI67,LMNB1         t
    #>                     Contrast
    #>                       <char>
