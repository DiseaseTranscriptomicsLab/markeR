...
- [Common Workflow](#common-workflow)
  - [1. Input Requirements](#id_1-input-requirements)  
  - [2. Select Mode of Analysis](#id_2-select-mode-of-analysis)  
  - [3. Choose a Quantification
    Approach](#id_3-choose-a-quantification-approach)
    - [3.1 Score-Based Approach](#id_31-score-based-approach)  
    - [3.2 Enrichment-Based
      Approach](#id_32-enrichment-based-approach)  
  - [4. Visualisation and
    Evaluation](#id_4-visualisation-and-evaluation)  
  - [5. Individual Gene Exploration
    (Optional)](#id_5-individual-gene-exploration-optional)  
  - [6. Compare with Reference Gene Sets
    (Optional)](#id_6-compare-with-reference-gene-sets-optional)  
