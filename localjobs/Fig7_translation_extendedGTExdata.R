...
process_tissue <- function(tissue) {
  ...
  subset_data <- 2^GTEx_alltissues[[tissue]]
  ...
  subset_data          <- subset_data[, subset_metadata$SAMPID]
...
saveRDS(results_df_gsea,  "../data_aux/results_df_gsea_GTEx_FPR_agecentered_extendedGTExdata.rds")
saveRDS(results_df_score, "../data_aux/results_df_score_GTEx_FPR_agecentered_extendedGTExdata.rds")
