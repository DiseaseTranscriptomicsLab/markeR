...
```{r exampleviolins, fig.width=10, fig.height=3, out.width="80%", warning=FALSE, message=FALSE}
...
```{r rocAUCexample, fig.width=12, fig.height=4, out.width="90%", warning=FALSE, message=FALSE}
...
```{r pca, fig.width=7, fig.height=3, out.width="60%", warning=FALSE, message=FALSE}
...
```{r exampleScore_2, fig.width=3, fig.height=4, out.width="40%", warning=FALSE, message=FALSE}
df_Scores <- CalculateScores(data = counts_example, 
                             metadata = metadata_example, 
                             method = "ssGSEA", 
                             gene_sets = list(Senescence=SimpleSenescenceSignature))
...
The following example uses the **"ranking"** method for score calculation.
