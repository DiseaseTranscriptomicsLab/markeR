...
-   **Highlight Gene Signatures:**  
    If you provide a list of gene signatures (via the `genes` argument), the function can highlight those genes on the plot.
...
```{r volcanos_DEGs2, fig.width=4, fig.height=6, out.width="40%", warning=FALSE, message=FALSE}
