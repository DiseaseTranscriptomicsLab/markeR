...
```{r heatmap_all, fig.width=6, fig.height=2, out.width="80%", warning=FALSE, message=FALSE}
...
```{r roc_scores, fig.width=6, fig.height=3, out.width="80%", warning=FALSE, message=FALSE}
