...
[![Minimal R Version](https://img.shields.io/badge/min%20R-4.5.0-blue.svg)](https://github.com/DiseaseTranscriptomicsLab/markeR/actions/workflows/Rminversion.yaml)
...
However, due to `Bioconductor` submission requirements, `R` version `4.5.0` is listed as required upon package installation.
