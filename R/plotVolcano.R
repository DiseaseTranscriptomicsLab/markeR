...
#'
#' @examples
#' # (Assumes you have already created `expr`, `metadata`, and run `calculateDE` as shown above)
...
#' sig_genes <- rownames(de_res[["A-B"]])[order(de_res[["A-B"]]$logFC, decreasing = TRUE)[1:5]]
#' plotVolcano(
#'   DEResultsList = de_res,
